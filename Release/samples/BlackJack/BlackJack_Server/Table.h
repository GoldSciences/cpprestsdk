...
public:
														DealerTable			()										: m_currentPlayer(0)						, m_betsMade(0), m_betting(true)	{ _init(); FillShoe(6		); }
														DealerTable			(int id, size_t capacity, int decks)	: BJTable(id, capacity), m_currentPlayer(0)	, m_betsMade(0), m_betting(true)	{ _init(); FillShoe(decks	); }
