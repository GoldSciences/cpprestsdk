...
web::json::value::value_type web::json::value::type() const { return m_value->type(); }
...
web::json::value&	web::json::details::_Object::index			(const utility::string_t &key) { return m_object[key]; }
bool				web::json::details::_Object::has_field		(const utility::string_t &key) const { return m_object.find(key) != m_object.end(); }
utility::string_t json::value::to_string() const {
    ...
    return m_value->to_string();
		...
		bool			web::json::value::operator==(const json::value &other) const {
    ...
    case Object		: return static_cast<const json::details::_Object	*>(this->m_value.get())->is_equal(static_cast<const json::details::_Object*>(other.m_value.get()));
    case Array		: return static_cast<const json::details::_Array	*>(this->m_value.get())->is_equal(static_cast<const json::details::_Array*>(other.m_value.get()));
    }
    __assume(0);
}
