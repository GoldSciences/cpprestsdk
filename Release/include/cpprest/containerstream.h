...
namespace Concurrency { namespace streams {
    ...
    public:
        typedef typename _CollectionType::value_type char_type;
            ...
            /// <param name="data">The collection that is the starting point for the buffer
        /// <param name="mode">The I/O mode that the buffer should use (in / out)
    ...
    public:
        ...
        typedef container_buffer<_CollectionType> buffer_type;
            ...
            /// </param name="data">STL container to back the input stream.
    ...
    public:
            ...
            /// <typeparam name="_CollectionType">The type of the STL collection.</typeparam>
        /// <param name="data">STL container to back the input stream.
        /// Returns an single byte character input stream.
        template<typename _CollectionType>
        static concurrency::streams::istream open_istream(_CollectionType data)
        {
            ...
            /// <typeparam name="_CollectionType">The type of the STL collection.</typeparam>
        /// Returns a single byte character output stream.
        template<typename _CollectionType>
